...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return getPageMetadata('New Arrivals', 'Discover the latest arrivals at Senlysh')
}

export default async function SenlyshNewArrivalsPage({ searchParams }: NewArrivalsPageProps) {
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-gray-600">Discover the latest fashion and lifestyle products</p>
        </div>
