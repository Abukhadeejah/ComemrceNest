...
export function OrganizationSection({
  ...
  const toggleCategory = useCallback(
    (categoryId: string) => {
      ...
      // Remove the parent category logic - no more primary category concept
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="mt-2 text-sm text-gray-500">
            Select one or more categories for this product. Products will appear in all selected categories.
          </p>
        </div>
      </div>
    </div>
