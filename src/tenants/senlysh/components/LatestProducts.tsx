      ...
      setVariantValidationError('');
                        ...
                        {option.values
                          ...
                          .map((value) => (
                            <button
                              ...
                              className={`text-xs border px-2 py-1 rounded transition-all duration-200
                                hover:border-purple-300 min-w-[32px] min-h-[24px]
          ...
          <div className="mt-auto relative z-10">
            ...
            {variantValidationError && (
              <div className="text-xs text-red-600 font-medium bg-red-50 p-2 rounded border border-red-200 mb-2">
                {variantValidationError}
              </div>
            )}
