import type { FooterProps } from '@/components/tenant/contracts'

export default function Gadget-bazaarFooter({ config, theme }: FooterProps) {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-lg font-bold">Gadget Bazaar</h3>
            </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-300">
              <p>📧 hello@Gadget-bazaar.com</p>
              <p>📱 (+91) 98765-43210</p>
              <p>📍 123 Business Street<br />New Delhi, 110001</p>
            </div>
          </div>
        </div>
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-300">
            © 2024 Gadget Bazaar. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
