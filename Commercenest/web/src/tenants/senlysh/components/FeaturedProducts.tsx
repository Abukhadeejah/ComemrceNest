...
const defaultProducts: FeaturedProduct[] = [
  ...
  {
    name: 'Beach ville red',
    image: 'https://images.unsplash.com/photo-1541643600914-78b084683601?w=400&h=400&fit=crop',
    price: 49,
    originalPrice: 59,
    badges: ['Featured', '-17%', 'Limited', 'Sold Out'],
    rating: 5.0,
    url: '/product/beach-ville-red'
  },
  {
    ...
    price: 19,
    originalPrice: 25,
    badges: ['Featured', '-24%', 'Limited'],
    url: '/product/t-shirt-caro-lines'
  }
];
        ...
        <div className="relative">
          <div className="flex gap-6 overflow-x-auto scrollbar-hide pb-6
            ...
            {products.map((product) => (
              <div key={product.name} className="group relative flex-shrink-0 w-80 sm:w-96 md:w-[400px] snap-start">
