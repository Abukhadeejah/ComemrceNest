...
export default function TermsAndConditions() {
  console.log("TermsAndConditions page component rendered");
  ...
  return (
    <div className="prose mx-auto p-4 max-w-4xl">
      ...
      <p>
        This document is an electronic record in terms of [translate:Information Technology Act, 2000] and rules there under as applicable and the amended provisions pertaining to electronic records in various statutes as amended by the [translate:Information Technology Act, 2000]. This electronic record is generated by a computer system and does not require any physical or digital signatures.
      </p>
      <p>
        This document is published in accordance with the provisions of Rule 3 (1) of the [translate:Information Technology (Intermediaries guidelines) Rules, 2011] that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name [https://senlysh.in/](https://senlysh.in/) ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').
      </p>
      <p>
        The Platform is owned by [translate:MAFIAA WESTERN OUTFIT], a company incorporated under the Companies Act, 1956 with its registered office at [translate:SHOP NO 1, NARMADA SMRUTI, CABIN ROAD, BHAYANDER EAST, THANE, MAHARASHTRA, INDIA 401105], Mumbai, India (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our').
      </p>
      <p>
