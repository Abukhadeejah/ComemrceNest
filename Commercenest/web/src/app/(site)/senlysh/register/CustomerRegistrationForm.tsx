    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-purple-50 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-4">Welcome to Senlysh!</h1>
          ...
          <div className="space-y-3">
            <Link 
              href={`/${tenantKey}`}
              className="block w-full px-6 py-3 bg-gradient-to-r from-pink-600 to-purple-600 text-white font-semibold rounded-lg hover:from-pink-700 hover:to-purple-700 transition-all duration-300"
            >
              Continue Shopping
            </Link>
            <Link 
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-purple-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Join Senlysh for exclusive fashion collections and personalized experiences</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-start space-x-3">
            ...
            <label htmlFor="marketingOptIn" className="text-sm text-gray-600">
              I would like to receive updates about new collections, exclusive offers, and fashion tips from Senlysh
            </label>
          </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-600">
            ...
            <Link href={`/${tenantKey}/login`} className="text-pink-600 hover:text-pink-700 font-semibold">
              Sign in
            </Link>
          </p>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-gray-500">
            ...
            <Link href={`/${tenantKey}/terms`} className="text-pink-600 hover:text-pink-700">
              Terms of Service
            </Link>{' '}
            and{' '}
            <Link href={`/${tenantKey}/privacy`} className="text-pink-600 hover:text-pink-700">
              Privacy Policy
            </Link>
          </p>
        </div>
