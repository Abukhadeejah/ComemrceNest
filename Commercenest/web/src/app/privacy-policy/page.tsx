...
export default function PrivacyPolicy() {
  ...
  return (
    <div className="prose mx-auto p-4 max-w-4xl">
      ...
      <p>
        This Privacy Policy describes how [translate:MAFIAA WESTERN OUTFIT] and its affiliates (collectively " [translate:MAFIAA WESTERN OUTFIT], we, our, us") collect, use, share, protect or otherwise process your information/ personal data through our website <a href="https://senlysh.in/">https://senlysh.in/</a> (hereinafter referred to as Platform).
      </p>
      <p>
      ...
      <p>
        If you receive an email, a call from a person/association claiming to be [translate:MAFIAA WESTERN OUTFIT] seeking any personal data like debit/credit card PIN, net-banking or mobile banking password, we request you to never provide such information. If you have already revealed such information, report it immediately to an appropriate law enforcement agency.
      </p>
