...
-- =====================================================
-- Purpose: Allow admins to create discount coupons
-- Features:
...
CREATE TABLE IF NOT EXISTS coupons (
  ...
  max_discount_cents INTEGER, -- For percentage discounts, cap the maximum discount
...
CREATE INDEX IF NOT EXISTS idx_coupon_usage_customer ON coupon_usage(tenant_id, customer_id);
...
-- GRANT SELECT, INSERT ON coupons TO authenticated;
-- GRANT SELECT, INSERT ON coupon_usage TO authenticated;
